...
export default function ProfilePage() {
  ...
  const handleSave = async () => {
    if (form.password && form.password !== form.confirmPassword) {
      showAlert("Password match nahi kar raha!", "danger"); return;
    }
    if (form.password && form.password.length < 6) {
      showAlert("Password kam se kam 6 characters ka hona chahiye!", "danger"); return;
    }
    ...
    try {
      ...
      const res = await fetch(`http://localhost:5000/user/${user.id || user._id}`, {
        method: "PUT",
        headers: {
  ...
  const roleBadge = user?.role === "farmer" ? "👨‍🌾 Farmer"
    : user?.role === "agent" ? "🏪 Agent" : "🛍️ Buyer";

  const roleColor = user?.role === "farmer" ? "success"
        ...
        <div className="container">
          <div className="row justify-content-center">
            <div className="col-md-8 col-lg-6">
              ...
              <div className="card border-0 shadow-sm rounded-4 mb-4 overflow-hidden">
                <div className="card-body p-0">
                  <div className="p-4 text-white text-center"
                    ...
                    <div className="rounded-circle bg-white text-success fw-bold mx-auto
                    ...
                    <span className={`badge bg-${roleColor} px-3 py-2`}>
                      {roleBadge}
                    </span>
                  </div>
              ...
              {/* Alert */}
              {msg && (
                <div className={`alert alert-${msgType} rounded-3 mb-3`}>{msg}</div>
              )}
                ...
                <div className="card-body p-4">
                  ...
                  <div className="row g-3">
                    <div className="col-12">
                      <label className="form-label fw-semibold">👤 Naam</label>
              ...
              {/* Logout */}
              <button className="btn btn-outline-danger w-100 fw-semibold rounded-3 mb-4"
                onClick={logout}>
                🚪 Logout
              </button>
