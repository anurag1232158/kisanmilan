  ...
  useEffect(() => {
    fetch("/api/services")
      ...
      .then((data) => {
        ...
        setAboutUsData(data.electrical || data);
      })
                ...
                <div className="col-md-12 col-sm-12 m-auto">
                  <div className="card">
                    <div className="card-body bg-grays1">
                      ...
                      >
                        Electrical Services : {aboutUsData.length}
                        <Link href="/AdminAddElectrical" className="mx-2">
                            ...
                            {currentContent.length > 0 ? (
                              currentContent.map((item, index) => (
                                <tr key={item.id} className="text-center">
                                  ...
                                  <td>
                                    <Link
                                      href={`/AdminViewElectrical/${item.id}`}
                                  ...
                                  <td>
                                    <Link
                                      href={`/AdminUpdateElectrical/${item.id}`}
