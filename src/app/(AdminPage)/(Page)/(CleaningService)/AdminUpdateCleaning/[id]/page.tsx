...
function AdminUpdateCleaning() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const res = await fetch(`/api/cleaningService?id=${params.id}`);
        if (res.ok) {
              ...
              <div className="border p-3 mb-3 bg-gradient">
                <div className="text-center">
                  <h5 className="mb-0 font-weight-medium fw-bold text-white">
                    ...
                    <Link href="/AdminCleaning" className="ms-2">
...
export default AdminUpdateCleaning;
