...
function AdminHome() {
  ...
  const handleDelete = async (id: string) => {
    ...
    try {
      const res = await fetch(`/api/cctv?id=${id}`, {
        method: "DELETE",
      });
      if (res.ok) {
                ...
                <div className="col-md-12 col-sm-12 m-auto">
                  <div className="card">
                    <div className="card-body bg-grays1">
                      ...
                      >
                        CCTV Services : {aboutUsData.length}
                        <Link href="/AdminAddCCTV" className="mx-2">
