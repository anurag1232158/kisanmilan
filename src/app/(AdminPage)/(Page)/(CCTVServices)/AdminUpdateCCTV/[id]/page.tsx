...
function AdminUpdateCCTV() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const res = await fetch(`/api/cctv?id=${params.id}`);
        if (res.ok) {
  ...
  const updateData = async (e: FormEvent<HTMLFormElement>) => {
    ...
    let errors: any = {};
    if (!data.name) errors.name = "CCTV Name is required";
              ...
              <div className="border p-3 mb-3 bg-gradient">
                <div className="text-center">
                  <h5 className="mb-0 font-weight-medium fw-bold text-white">
                    {" "}
                    Update CCTV Service
                    <Link href="/AdminCCTV" className="ms-2">
                          ...
                          <div className="col-md-4">
                            <div className="mb-3 fw-bold">
                              ...
                              >
                                ...
                                <option value="CCTV Upgrades">
                                  CCTV Upgrades
                                </option>
                                <option value="IP Camera Installation">
                                  IP Camera Installation
                                </option>
                                <option value="DVR/NVR Setup - Digital">
                                  DVR/NVR Setup - Digital
                                </option>
                                <option value="Remote Monitoring Setup">
                                  Remote Monitoring Setup
                                </option>
                                <option value="CCTV Camera Installation">
                                  CCTV Camera Installation
                                </option>
                                <option value="CCTV Maintenance & Repair">
                                  CCTV Maintenance & Repair
                                </option>
                                <option value="Cabling & Wiring Services">
                                  Cabling & Wiring Services
                                </option>
                                <option value="Wireless CCTV Installation">
                                  Wireless CCTV Installation{" "}
                                </option>
                                <option value="Surveillance System Consultation">
                                  Surveillance System Consultation{" "}
                                </option>
                                <option value="Motion Detection & Alarm Integration">
                                  Motion Detection & Alarm Integration
                                </option>
                              </select>
...
export default AdminUpdateCCTV;
