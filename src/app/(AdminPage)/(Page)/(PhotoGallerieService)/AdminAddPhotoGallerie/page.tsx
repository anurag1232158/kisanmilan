...
function AdminHome() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await fetch("/api/photoGallerie");
        if (response.ok) {
  ...
  const postData = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      const res = await fetch("/api/photoGallerie", {
        method: "POST",
      ...
      if (res.ok) {
        alert("✅ Photo Gallerie Service added successfully!");
            ...
            <div className="container-fluid px-4">
              <div className="border">
                <div className="text-center">
                  ...
                  >
                    Add Photo Gallerie Service
                    <Link href="/AdminPhotoGallerie">
                      {" "}
