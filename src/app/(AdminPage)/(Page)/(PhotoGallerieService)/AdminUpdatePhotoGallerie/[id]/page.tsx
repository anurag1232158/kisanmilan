...
function AdminUpdatePhotoGallerie() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const res = await fetch(`/api/photoGallerie?id=${params.id}`);
        if (res.ok) {
          const result = await res.json();
          setData(result);
        }
      } catch (err) {
        console.error("Error fetching photoGallerie:", err);
      }
    };
  ...
  const updateData = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        router.push("/AdminPhotoGallerie");
      }
    } catch (err) {
              ...
              <div className="border p-3 mb-3 bg-gradient">
                <div className="text-center">
                  <h5 className="mb-0 font-weight-medium fw-bold text-white">
                    {" "}
                    Update Photo Gallerie Service
                    <Link href="/AdminPhotoGallerie" className="ms-2">
                    ...
                    <div className="card-body bg-grays1">
                      <form onSubmit={updateData} className="mt-2">
                          ...
                          <div className="col-md-4">
                            <div className="mb-3 fw-bold">
                              ...
                              >
                                ...
                                <option value="Drone/ Aerial Photography">
                                  Drone/ Aerial Photography{" "}
                                </option>
                                <option value="Travel & Landscape Photography">
                                  Travel & Landscape Photography{" "}
                                </option>
                                <option value="Photo Editing & Album Designing">
                                  Photo Editing & Album Designing{" "}
                                </option>
                                <option value="Architectural & Interior Photography">
                          ...
                          <div className="col-md-4">
                            <div className="mb-3 fw-bold">
                              ...
                              >
                                ...
                                <option value="Photo Editing Services">
                        ...
                        <div className="mb-3 btn-group w-100 py-5">
                          <button
                            type="button"
                            onClick={() => router.push("/AdminPhotoGallerie")}
...
export default AdminUpdatePhotoGallerie;
