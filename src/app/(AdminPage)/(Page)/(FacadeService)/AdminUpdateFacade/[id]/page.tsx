...
function AdminUpdateFacade() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const res = await fetch(`/api/facade?id=${params.id}`);
        if (res.ok) {
              ...
              <div className="border p-3 mb-3 bg-gradient">
                <div className="text-center">
                  <h5 className="mb-0 font-weight-medium fw-bold text-white">
                    ...
                    <Link href="/AdminFacade" className="ms-2">
                    ...
                    <div className="card-body bg-grays1">
                      <form onSubmit={updateData} className="mt-2">
                          ...
                          <div className="col-md-4">
                            <div className="mb-3 fw-bold">
                              ...
                              >
                                ...
                                <option value="Glass Facade">
                                  Glass Facade
                                </option>
                                <option value="Metal Facade">
                                  Metal Facade
                                </option>
                                <option value="Concrete/Plaster">
                                  Concrete/Plaster
                                </option>
                                <option value="Industrial Facade">
                                  Industrial Facade
                                </option>
                                <option value="High-Rise/Industrial">
                                  High-Rise/Industrial
                                </option>
                                <option value="Specialty Treatments">
                                  Specialty Treatments
                                </option>
                                <option value="Stone/Marble Facade">
                                  Stone/Marble Facade{" "}
                                </option>
                              </select>
                        ...
                        <div className="mb-3 btn-group w-100 py-5">
                          <button
                            type="button"
                            onClick={() => router.push("/AdminFacade")}
...
export default AdminUpdateFacade;
