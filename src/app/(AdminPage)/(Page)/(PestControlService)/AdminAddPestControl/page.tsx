...
function AdminHome() {
  ...
  const postData = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      const res = await fetch("/api/pestControl", {
        method: "POST",
      ...
      if (res.ok) {
        alert("✅ Pest Control Service added successfully!");
                          ...
                          <div className="col-md-6">
                            <div className="mb-3 fw-bold">
                              ...
                              <textarea
                                ...
                                className="form-control mt-2"
                                id=""
                                placeholder="Enter Pest Control Description"
                          ...
                          <div className="col-md-6">
                            <div className="mb-3 fw-bold">
                              ...
                              <textarea
                                ...
                                className="form-control mt-2"
                                id=""
                                placeholder="Enter Pest Control Details"
                                value={data.details}
                                rows={4}
                                onChange={getInputData}
                              ></textarea>
