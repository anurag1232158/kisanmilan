...
function AdminUpdatePestControl() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const res = await fetch(`/api/pestControl?id=${params.id}`);
        if (res.ok) {
  ...
  const updateData = async (e: FormEvent<HTMLFormElement>) => {
    ...
    let errors: any = {};
    if (!data.name) errors.name = "PestControl Name is required";
              ...
              <div className="border p-3 mb-3 bg-gradient">
                <div className="text-center">
                  <h5 className="mb-0 font-weight-medium fw-bold text-white">
                    ...
                    <Link href="/AdminPestControl" className="ms-2">
                    ...
                    <div className="card-body bg-grays1">
                      <form onSubmit={updateData} className="mt-2">
                        <div className="row">
                          <div className="col-md-4">
                            <div className="mb-3 fw-bold">
                              ...
                              >
                                ...
                                <option value="Rodent Control ">
                                  Rodent Control{" "}
                                </option>
                                <option value="Termite Control ">
                                  Termite Control{" "}
                                </option>
                                <option value="Mosquito Control ">
                                  Mosquito Control{" "}
                                </option>
                                ...
                                <option value="Spider & Lizard Control ">
                          ...
                          <div className="col-md-4">
                            ...
                            >
                              ...
                              <option value="2-3 hour">2-3 hour</option>
                            </select>
                          </div>
                        </div>
                        ...
                        <div className="mb-3 btn-group w-100 py-5">
                          <button
                            type="button"
                            onClick={() => router.push("/AdminPestControl")}
...
export default AdminUpdatePestControl;
