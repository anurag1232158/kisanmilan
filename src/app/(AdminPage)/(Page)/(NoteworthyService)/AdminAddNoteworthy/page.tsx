...
function AdminHome() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await fetch("/api/noteworthy");
        if (response.ok) {
  ...
  const postData = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      const res = await fetch("/api/noteworthy", {
        method: "POST",
      ...
      if (res.ok) {
        alert("✅ Noteworthy Service added successfully!");
            ...
            <div className="container-fluid px-4">
              <div className="border">
                <div className="text-center">
                  ...
                  >
                    Add Noteworthy Service
                    <Link href="/AdminNoteworthy">
                      {" "}
                          ...
                          <div className="col-md-4">
                            <div className="mb-3 fw-bold">
                              ...
                              >
                                ...
                                <option value="Painting & Finishes">
                                  Painting & Finishes
                                </option>
                                ...
                                <option value="Electronics Restoration">
