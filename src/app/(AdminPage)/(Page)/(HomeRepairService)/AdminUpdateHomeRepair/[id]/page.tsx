...
function AdminUpdateHomeRepair() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const res = await fetch(`/api/homeRepair?id=${params.id}`);
        if (res.ok) {
          const result = await res.json();
          setData(result);
        }
      } catch (err) {
        console.error("Error fetching HomeRepair:", err);
      }
    };
  ...
  const updateData = async (e: FormEvent<HTMLFormElement>) => {
    ...
    let errors: any = {};
    if (!data.name) errors.name = "HomeRepair Name is required";
              ...
              <div className="border p-3 mb-3 bg-gradient">
                <div className="text-center">
                  <h5 className="mb-0 font-weight-medium fw-bold text-white">
                    {" "}
                    Update Home Repair Service
                    <Link href="/AdminHomeRepair" className="ms-2">
                    ...
                    <div className="card-body bg-grays1">
                      <form onSubmit={updateData} className="mt-2">
                        <div className="row">
                          <div className="col-md-4">
                            <div className="mb-3 fw-bold">
                              ...
                              >
                                ...
                                <option value="Masonry & Civil Work">
                                  Masonry & Civil Work
                                </option>
                                <option value="Glass & Aluminium Work ">
                                ...
                                <option value="Pantry & Kitchenette HomeRepair ">
                                  Pantry & Kitchenette HomeRepair{" "}
                                </option>
                              </select>
                          ...
                          <div className="col-md-4">
                            <div className="mb-3 fw-bold">
                              ...
                              >
                                ...
                                <option value="Commercial Repair">
                                  Commercial Repair
                                </option>
                          ...
                          <div className="col-md-4">
                            ...
                            >
                              ...
                              <option value="1-2 hours">1-2 days</option>
                              <option value="2-3 hours">2-3 days</option>
                        ...
                        <div className="mb-3 btn-group w-100 py-5">
                          <button
                            type="button"
                            onClick={() => router.push("/AdminHomeRepair")}
...
export default AdminUpdateHomeRepair;
