...
function AdminHome() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await fetch("/api/homeRepair");
        if (response.ok) {
  ...
  const postData = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      const res = await fetch("/api/homeRepair", {
        method: "POST",
      ...
      if (res.ok) {
        alert("✅ homeRepair Service added successfully!");
            ...
            <div className="container-fluid px-4">
              <div className="border">
                <div className="text-center">
                  ...
                  >
                    Add Home Repair Service
                    <Link href="/AdminHomeRepair">
                      {" "}
                          ...
                          <div className="col-md-6">
                            <div className="mb-3 fw-bold">
                              ...
                              <textarea
                                ...
                                className="form-control mt-2"
                                id=""
                                placeholder="Enter Home Repair Description"
                          ...
                          <div className="col-md-6">
                            <div className="mb-3 fw-bold">
                              ...
                              <textarea
                                ...
                                className="form-control mt-2"
                                id=""
                                placeholder="Enter Home Repair Details"
                                value={data.details}
                                rows={4}
                                onChange={getInputData}
                              ></textarea>
