...
function AdminUpdatePainting() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const res = await fetch(`/api/painting?id=${params.id}`);
        if (res.ok) {
  ...
  const updateData = async (e: FormEvent<HTMLFormElement>) => {
    ...
    let errors: any = {};
    if (!data.name) errors.name = "Painting Name is required";
              ...
              <div className="border p-3 mb-3 bg-gradient">
                <div className="text-center">
                  <h5 className="mb-0 font-weight-medium fw-bold text-white">
                    {" "}
                    Update Painting Service
                    <Link href="/AdminPainting" className="ms-2">
                    ...
                    <div className="card-body bg-grays1">
                      <form onSubmit={updateData} className="mt-2">
                          ...
                          <div className="col-md-4">
                            <div className="mb-3 fw-bold">
                              ...
                              >
                                ...
                                <option value="Specialty Painting ">
                                  Specialty Painting{" "}
                                </option>
                                <option value="Industrial Painting">
                                  Industrial Painting{" "}
                                </option>
                                <option value="Commercial Painting">
                                  Commercial Painting
                                </option>
                                <option value="Wood Painting & Polishing">
                                  Wood Painting & Polishing{" "}
                                </option>
                                <option value="Texture & Decorative Painting">
                                  Texture & Decorative Painting
                                </option>
                                <option value="Repainting & Renovation Painting">
                                  Repainting & Renovation Painting
                                </option>
                                <option value="Waterproof & Protective Coatings">
                        ...
                        <div className="mb-3 btn-group w-100 py-5">
                          <button
                            type="button"
                            onClick={() => router.push("/AdminPainting")}
...
export default AdminUpdatePainting;
